...
# 3.WAP that accepts a character and performs the following:<br/>
...
# 4.WAP to perform the following operations on a string<br/>
...
# 5.WAP to swap the first n characters of two strings:
