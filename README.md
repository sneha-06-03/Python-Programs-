...
<br/>
<br/>
# 8.WAP to create a list of the cubes of only the even integers appearing in the input list (may have elements of other types also) using the following:(a) 'for' loop. (b) list comprehension<br/>
![Screenshot 2024-11-10 224921](https://github.com/user-attachments/assets/b6e5fbd9-7af1-48b7-966b-b0f8d5411246)<br/>
<br/>
# 9.WAP to read a file and (a) Print the total number of characters, words and lines in the file.(b)Calculate the frequency of each character in the file. Use a variable of dictionary type to maintain the count. . (c) Print the words in reverse order.
